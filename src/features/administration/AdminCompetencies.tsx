  ...
  return (
    <div className="space-y-6">
      ...
      <ScopeNotice>
        ...
        : la validation par un tiers habilité est obligatoire. Les états affichés ici viennent des
        déclarations et des validations réelles.
      </ScopeNotice>
      ...
      */}
        ...
        {realCurriculumVersionId ? (
          ...
          <EmptyState>
            Aucune version de curriculum pour ce programme : le référentiel de compétences ne peut
