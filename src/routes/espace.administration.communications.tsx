...
export const Route = createFileRoute("/espace/administration/communications")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modèles de messages, relances préparées et historique simulé." },
      { property: "og:title", content: "Communications du programme — Mon Passeport Éducatif" },
      { property: "og:description", content: "Modèles de messages, relances préparées et historique simulé." },
