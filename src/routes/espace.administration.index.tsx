...
export const Route = createFileRoute("/espace/administration/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Indicateurs de promotion, tâches prioritaires, alertes et validations." },
      { property: "og:title", content: "Pilotage du programme — Mon Passeport Éducatif" },
      { property: "og:description", content: "Indicateurs de promotion, tâches prioritaires, alertes et validations." },
