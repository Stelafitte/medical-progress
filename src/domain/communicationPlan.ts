...
export type PlanAudienceKind =
  "all_participants" | "incomplete_participants" | "submitted_participants" | "facilitators";
...
export const DEFAULT_PLAN_RULE_SET: PlanRuleSet = {
  ...
  rules: [
    ...
    rule(
      ...
      { kind: "same_day" },
      "all_participants",
      "{{programTitle}} — confirmation d'inscription",
    ),
    rule(
      "enrollment_welcome",
      "enrollment",
      ...
      "announcement",
      "start",
      { kind: "days_after", days: 1 },
      "all_participants",
      "Bienvenue dans {{programTitle}}",
    ),
    rule(
      "enrollment_practical",
      "enrollment",
      "Informations pratiques",
      "announcement",
      "end",
      { kind: "days_before", days: 2 },
      "all_participants",
      "{{programTitle}} — informations pratiques",
    ),
    // Audit A1
    rule(
      "a1_open",
      "audit_a1",
      "Ouverture de l'audit A1",
      "announcement",
      "start",
      { kind: "same_day" },
      "all_participants",
      "Ouverture de l'audit A1 — {{programTitle}}",
    ),
    rule(
      "a1_reminder_before",
      "audit_a1",
      "Rappel avant échéance de l'audit A1",
      "reminder",
      "end",
      { kind: "days_before", days: 7 },
      "all_participants",
      "Audit A1 — échéance proche",
    ),
    rule(
      "a1_reminder_incomplete",
      "audit_a1",
      "Rappel aux participants incomplets (A1)",
      "reminder",
      "end",
      { kind: "days_before", days: 2 },
      "incomplete_participants",
      "Audit A1 incomplet — {{programTitle}}",
    ),
    rule(
      "a1_submission_confirmation",
      "audit_a1",
      "Confirmation de soumission A1",
      "announcement",
      "end",
      { kind: "same_day" },
      "submitted_participants",
      "Audit A1 — soumission enregistrée",
    ),
    rule(
      "a1_feedback_available",
      "audit_a1",
      "Disponibilité de l'analyse personnalisée A1",
      "announcement",
      "end",
      { kind: "days_after", days: 7 },
      "submitted_participants",
      "Votre analyse personnalisée A1 est disponible",
    ),
    // Présentiel
    rule(
      "in_person_convocation",
      "in_person",
      "Convocation à la formation présentielle",
      "convocation",
      "start",
      { kind: "days_before", days: 15 },
      "all_participants",
      "Convocation — {{programTitle}}",
    ),
    rule(
      "in_person_place_time",
      "in_person",
      "Rappel avec lieu et horaires",
      "reminder",
      "start",
      { kind: "days_before", days: 7 },
      "all_participants",
      "Lieu et horaires — {{programTitle}}",
    ),
    rule(
      "in_person_eve",
      "in_person",
    ...
    rule(
      "in_person_change",
      "in_person",
      "Information pratique ou modification",
      "announcement",
      "start",
      { kind: "days_before", days: 2 },
      "all_participants",
      "Information pratique — {{programTitle}}",
    ),
    // Visioconférence
    rule(
      "virtual_convocation",
      "virtual_classroom",
      "Convocation à la visioconférence",
      "convocation",
      "start",
      { kind: "days_before", days: 15 },
      "all_participants",
      "Convocation visioconférence — {{programTitle}}",
    ),
    rule(
      "virtual_join_link",
      "virtual_classroom",
      ...
      { kind: "days_before", days: 2 },
      "all_participants",
      "Lien de connexion — {{programTitle}}",
    ),
    rule(
      "virtual_reminder",
      "virtual_classroom",
      ...
      { kind: "days_before", days: 1 },
      "all_participants",
      "Rappel séance en visioconférence",
    ),
    rule(
      "virtual_change",
      "virtual_classroom",
      ...
      { kind: "days_before", days: 7 },
      "all_participants",
      "Modification de la séance — {{programTitle}}",
    ),
    // E-formation
    rule(
      "elearning_open",
    ...
    rule(
      ...
      { kind: "days_before", days: 15 },
      "all_participants",
      "Pensez à consulter vos ressources",
    ),
    rule(
      "elearning_required_incomplete",
      "e_learning",
      "Relance des ressources obligatoires non terminées",
      "reminder",
      "end",
      { kind: "days_before", days: 7 },
      "incomplete_participants",
      "Ressources obligatoires non terminées",
    ),
    rule(
      "elearning_closing",
      "e_learning",
      ...
      { kind: "days_before", days: 2 },
      "all_participants",
      "Fermeture prochaine de l'e-formation",
    ),
    // Pré-test / post-test
    rule(
      "pretest_open",
      ...
      { kind: "same_day" },
      "all_participants",
      "Ouverture du test — {{programTitle}}",
    ),
    rule(
      "pretest_reminder",
      "pre_test",
      ...
      { kind: "days_before", days: 2 },
      "incomplete_participants",
      "Test à compléter — {{programTitle}}",
    ),
    rule(
      "pretest_completed",
      "pre_test",
      "Confirmation de complétude",
      "announcement",
      "end",
      { kind: "same_day" },
      "submitted_participants",
      "Test complété — {{programTitle}}",
    ),
    rule(
      "posttest_open",
      "post_test",
      "Ouverture du post-test",
      "announcement",
      "start",
      { kind: "same_day" },
      "all_participants",
    ...
    rule(
      ...
      { kind: "days_before", days: 2 },
      "incomplete_participants",
      "Post-test à compléter",
    ),
    rule(
      "posttest_completed",
      "post_test",
      "Confirmation de complétude du post-test",
      "announcement",
      "end",
      { kind: "same_day" },
      "submitted_participants",
    ...
    rule(
      "a2_open",
      "audit_a2",
      "Annonce de l'ouverture de l'audit A2",
      "announcement",
      "start",
      { kind: "same_day" },
      "all_participants",
      "Ouverture de l'audit A2",
    ),
    rule(
      "a2_reminder_before",
      "audit_a2",
      "Rappel avant clôture de l'audit A2",
      "reminder",
      "end",
      { kind: "days_before", days: 7 },
      "all_participants",
      "Audit A2 — clôture proche",
    ),
    rule(
      "a2_reminder_incomplete",
      "audit_a2",
      "Relance des audits A2 incomplets",
      "reminder",
      "end",
      { kind: "days_before", days: 2 },
      "incomplete_participants",
    ...
    rule(
      "a2_submission_confirmation",
      "audit_a2",
      "Confirmation de soumission A2",
      "announcement",
      "end",
      { kind: "same_day" },
      "submitted_participants",
      "Audit A2 — soumission enregistrée",
    ),
    rule(
      "a2_synthesis_available",
      "audit_a2",
      "Disponibilité de la synthèse comparative",
      "announcement",
      "end",
      { kind: "days_after", days: 7 },
      "submitted_participants",
      "Synthèse comparative disponible",
    ),
    // Fin de parcours
    rule(
      "completion_improvement_plan",
      "completion",
      "Plan d'amélioration disponible",
      "announcement",
      "start",
      { kind: "same_day" },
      "all_participants",
      "Votre plan d'amélioration est disponible",
    ),
    rule(
    ...
    rule(
      ...
      "reminder",
      "start",
      { kind: "after_overdue", days: 7 },
      "incomplete_participants",
      "Parcours incomplet — {{programTitle}}",
    ),
    rule(
      "completion_closing",
      "completion",
...
export function reconcileCommunicationPlan(
  ...
  for (const previous of plan.proposals) {
    ...
    const merged: CommunicationProposal = {
      ...next,
      state: previous.state === "disabled" ? "disabled" : next.state,
    };
    result.push(merged);
...
export function approvedProposals(plan: CommunicationPlan): readonly CommunicationProposal[] {
