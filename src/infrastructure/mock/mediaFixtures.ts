...
export const mediaResources: readonly MediaResource[] = [
  /* ---------------------------- DIU Échocardiographie ---------------------- */
  {
    ...
    title: "Bases physiques du Doppler — cours sonorisé réel",
    kind: "slides_audio",
    module: "Bases physiques et anatomiques",
    description:
      "Cours DIU réellement converti en 31 diapositives intégrales et 31 pistes audio pour le lecteur HTML5 expérimental.",
    ...
    asset: {
      kind: "file",
      label: "cours-doppler-sonorise.pptx",
      sizeHint: "19 Mo",
      durationMinutes: 15,
      hasTranscript: false,
    ...
    narrated: {
      ...
      target: "html5",
      source: {
        fileName: "cours-doppler-sonorise.pptx",
        sizeHint: "19 Mo",
      ...
      artifact: {
        state: "published",
        slideCount: 31,
        totalDurationSeconds: 909,
        hasTranscript: false,
        webPlayerUrl: "/demo/narrated-doppler/player/index.html",
        chapters: coupesChapters,
        slides: Array.from({ length: 31 }, (_, index) =>
          slide(
            index + 1,
            `Bases physiques du Doppler — diapositive ${index + 1}`,
            index === 30 ? 39 : 29,
            "",
          ),
        ),
  ...
  },
  {
    ...
    programId: "prog-diu-echo",
    title: "Recommandations de quantification — page web de référence",
    kind: "web_page",
    module: "Acquisition et mesures",
    description:
      "Ancien lien externe simple converti en page web HTML : seul l'instantané extrait, nettoyé, structuré, versionné et validé alimente le corpus IA.",
    outcomeIds: ["out-echo-fevg"],
    version: "instantané 2026-04",
    status: "published",
    visibility: "program",
    authorPersonId: "per-admin",
    ...
    asset: {
      kind: "url",
      label: "exemple-recommandations.test/quantification",
      storageActivated: false,
    },
    webPage: {
      ...
      precheck: checkWebPageUrl({
        ...
        detectedLanguage: "fr",
        sectionCount: 9,
        lastAnalyzedAt: "2026-04-01T08:00:00Z",
        changeDetected: false,
      }),
      steps: [
        { step: "declared", state: "done", at: "2026-03-08T09:15:00Z" },
        { step: "extract_main_content", state: "done", at: "2026-03-30T09:00:00Z" },
        {
          step: "clean_navigation",
          state: "done",
          at: "2026-03-30T09:06:00Z",
          note: "Menus et encarts éditeur écartés.",
        },
        { step: "structure_content", state: "done", at: "2026-03-30T09:12:00Z" },
        {
          step: "snapshot_version",
          state: "done",
          at: "2026-03-30T09:15:00Z",
          note: "Instantané « 2026-04 » figé, aucun HTML brut conservé.",
        },
        { step: "pedagogical_review", state: "done", at: "2026-04-01T10:00:00Z" },
        { step: "ai_indexing", state: "done", at: "2026-04-02T09:00:00Z" },
        { step: "publication", state: "done", at: "2026-04-02T09:15:00Z" },
      ],
      validatedSnapshot: {
        version: "instantané 2026-04",
        capturedAt: "2026-03-30T09:15:00Z",
        language: "fr",
        detectedTitle: "Recommandations de quantification des cavités",
        sections: [
          {
      ...
      refreshToReview: false,
      lastCheckedAt: "2026-04-01T08:00:00Z",
    ...
    versions: [
      {
        ...
        authorPersonId: "per-admin",
        summary: "Ajout du lien de référence (lien externe simple, hors corpus IA).",
        status: "draft",
      },
      {
        version: "instantané 2026-04",
        changedAt: "2026-04-02T09:15:00Z",
        authorPersonId: "per-admin",
        summary: "Conversion en page web HTML : instantané extrait, validé puis publié.",
        status: "published",
      },
    ],
    provenance: native,
