...
export const mockDataAccess: DataAccess = {
  ...
  assessments: (() => {
    ...
    return {
      ...
      readQuestion: () => Promise.reject(new Error("Aucune question en mode local.")),
      answerQuestion: () => Promise.reject(new Error("Aucune question en mode local.")),
      ...
      readCase: () => Promise.reject(new Error("Aucun dossier en mode local.")),
      answerCaseStep: () => Promise.reject(new Error("Aucun dossier en mode local.")),
      myCaseResults: () => ok([]),
